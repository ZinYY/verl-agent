...
# Find latest checkpoint and merge FSDP shards to HF model
LATEST_CKPT=$(ls -td ${CKPT_DIR}/global_step_*/actor 2>/dev/null | head -1)
if [ -n "$LATEST_CKPT" ]; then
    echo "Merging FSDP checkpoint from: $LATEST_CKPT"
